<footer>
    <div class="container-fluid text-center" style="padding: 10px 0;">
        <div class="container">
            <div class="row justify-content-evenly">
                ...
                <div class="col-md-3">
                    ...
                    <div class="row">
                        <p class="text-start"><a href="https://covid19.go.id/">Gugus Tugas Percepatan Penanganan COVID 19</a></p>
                        <p class="text-start"><a href="https://kawalcovid19.id/">Kawal COVID 19</a></p>
                        <p class="text-start"><a href="https://www.halodoc.com/kesehatan/coronavirus">halodoc</a></p>
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="row" style="padding: 10px 0;">
            <span><img src=<?= base_url('logo.png') ?> alt="" style="width: 5%;"></span>
        </div>
        <div class="row" style="padding: 10px 0;">
            <p>© 2020 Copyright Reserved</p>
        </div>
    </div>
</footer>
</body>
