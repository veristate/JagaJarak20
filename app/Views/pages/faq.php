<div class="container-fluid" style="padding-bottom:12vh; padding-top:12vh">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row" style="margin-top:6vh; font-size:15px; margin-bottom: 100px;">
            <div class="col-md-12">
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse15" aria-expanded="false" aria-controls="collapsefour">
                                Kapan vaksin COVID-19 siap untuk didistribusikan ?
                            </button>
                        </h2>
                        <div id="collapse15" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse16" aria-expanded="false" aria-controls="collapsefour">
                                Bagaimana skema penahapan pemberian vaksin di Indonesia ?
                            </button>
                        </h2>
                        <div id="collapse16" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse17" aria-expanded="false" aria-controls="collapsefour">
                                Kalau saya dinyatakan positif COVID-19, apakah pemerintah akan menanggung seluruh biaya pengobatannya?
                            </button>
                        </h2>
                        <div id="collapse17" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                                Ya. Berdasarkan Keputusan Menteri Kesehatan Nomor HK.01.07/ MENKES/104/2020 tanggal 4 Februari 2020 dan KMK No. HK.01.07-MENKES-238-2020 tentang JUKNIS Penggantian Biaya Pasien Infeksi Emerging Tertentu, seluruh biaya tes dan perawatan pasien yang terkonfirmasi positif COVID-19 akan ditanggung oleh pemerintah.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse18" aria-expanded="false" aria-controls="collapsefour">
                                Apakah vaksin COVID-19 juga akan diberikan pada masyarakat yang berusia lebih dari 60 tahun ?
                            </button>
                        </h2>
                        <div id="collapse18" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse19" aria-expanded="false" aria-controls="collapsefour">
                                Apakah vaksin COVID-19 melindungi secara jangka panjang ?
                            </button>
                        </h2>
                        <div id="collapse19" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse20" aria-expanded="false" aria-controls="collapsefour">
                                Bagaimana vaksin COVID-19 dikembangkan ?
                            </button>
                        </h2>
                        <div id="collapse20" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
                                <p>Meski pada saat darurat dan dibutuhkan dengan cepat, keamanan dan efektivitas vaksin adalah prioritas utama. Pengembangan vaksin tetap harus melalui tahapan pengembangan yang berlaku internasional yang secara umum terdiri dari:</p>
                                <ul>
                                    <li>Tahap praklinik</li>
                                    <li>Tahap klinis (fase 1-3)</li>
                                    <li>Penetapan penggunaan vaksin</li>
                                </ul>
                                <p>Sembari menunggu vaksin COVID-19 siap tersedia untuk masyarakat, maka kita harus tetap melawan pandemi ini dengan patuh protokol kesehatan: #PakaiMasker #JagaJarak #CuciTanganPakaiSabun</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse21" aria-expanded="false" aria-controls="collapsefour">
                                Seberapa ampuh vaksin COVID-19 melindungi kita dari penularan ?
                            </button>
                        </h2>
                        <div id="collapse21" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
                            <div align="justify" class="accordion-body">
